...
#     a.append(fig[i].add_subplot(1,1,1))

# for i in range(21):
#     globals()[f"fig_{i}"] = []
    # globals()[f"fig{i}"] = plt.figure() -> Opens 20 figures
    
# fig_0 = plt.figure()
# a0 = fig_0.add_subplot(1,1,1)
# 
# fig_1 = plt.figure()
# a1 = fig_1.add_subplot(1,1,1)
# 
# fig_2 = plt.figure()
# a2 = fig_2.add_subplot(1,1,1)
# 
# fig_3 = plt.figure()
# a3 = fig_3.add_subplot(1,1,1)
# 
# fig_4 = plt.figure()
# a4 = fig_4.add_subplot(1,1,1)
# 
# fig_5 = plt.figure()
# a5 = fig_5.add_subplot(1,1,1)
# 
# fig_6 = plt.figure()
# a6 = fig_6.add_subplot(1,1,1)
# 
# fig_7 = plt.figure()
# a7 = fig_7.add_subplot(1,1,1)
# 
# fig_8 = plt.figure()
# a8 = fig_8.add_subplot(1,1,1)
# 
# fig_9 = plt.figure()
# a9 = fig_9.add_subplot(1,1,1)
# 
# fig_10 = plt.figure()
# a10 = fig_10.add_subplot(1,1,1)
# 
# fig_11 = plt.figure()
# a11 = fig_11.add_subplot(1,1,1)
# 
# fig_12 = plt.figure()
# a12 = fig_12.add_subplot(1,1,1)
# 
# fig_13 = plt.figure()
# a13 = fig_13.add_subplot(1,1,1)
# 
# fig_14 = plt.figure()
# a14 = fig_14.add_subplot(1,1,1)
# 
# fig_15 = plt.figure()
# a15 = fig_15.add_subplot(1,1,1)
# 
# fig_16 = plt.figure()
# a16 = fig_16.add_subplot(1,1,1)
# 
# fig_17 = plt.figure()
# a17 = fig_17.add_subplot(1,1,1)
# 
# fig_18 = plt.figure()
# a18 = fig_18.add_subplot(1,1,1)
# 
# fig_19 = plt.figure()
# a19 = fig_19.add_subplot(1,1,1)
# 
# fig_20 = plt.figure()
# a20 = fig_20.add_subplot(1,1,1)
...
#while True :
#for i in range(8) :
    # the voltage output(vout) from the voltage divider formed
# tdict[0] = (((adc1.read(channel = 0))/1023)*3.3)
# tdict[1] = (((adc1.read(channel = 1))/1023)*3.3)
# tdict[2] = (((adc1.read(channel = 2))/1023)*3.3)
# tdict[3] = (((adc1.read(channel = 3))/1023)*3.3)
# tdict[4] = (((adc1.read(channel = 4))/1023)*3.3)
# tdict[5] = (((adc1.read(channel = 5))/1023)*3.3)
# tdict[6] = (((adc1.read(channel = 6))/1023)*3.3)
# tdict[7] = (((adc1.read(channel = 7))/1023)*3.3)
# tdict[8] = (((adc2.read(channel = 0))/1023)*3.3)
# tdict[9] = (((adc2.read(channel = 1))/1023)*3.3)
# tdict[10] = (((adc2.read(channel = 2))/1023)*3.3)
# tdict[11] = (((adc2.read(channel = 3))/1023)*3.3)
# tdict[12] = (((adc2.read(channel = 4))/1023)*3.3)
# tdict[13] = (((adc2.read(channel = 5))/1023)*3.3)
# tdict[14] = (((adc2.read(channel = 6))/1023)*3.3)
# tdict[15] = (((adc2.read(channel = 7))/1023)*3.3)
# tdict[16] = (((adc3.read(channel = 0))/1023)*3.3)
# tdict[17] = (((adc3.read(channel = 1))/1023)*3.3)
# tdict[18] = (((adc3.read(channel = 2))/1023)*3.3)
# tdict[19] = (((adc3.read(channel = 3))/1023)*3.3)

# the resistance of PT100 using vin(5V) and r1(3.3K Ohms)
# tdict[0] = (r1*(1/((vin/tdict[0]) - 1)))
# tdict[1] = (r1*(1/((vin/tdict[1]) - 1)))
# tdict[2] = (r1*(1/((vin/tdict[2]) - 1)))
# tdict[3] = (r1*(1/((vin/tdict[3]) - 1)))
# tdict[4] = (r1*(1/((vin/tdict[4]) - 1)))
# tdict[5] = (r1*(1/((vin/tdict[5]) - 1)))
# tdict[6] = (r1*(1/((vin/tdict[6]) - 1)))
# tdict[7] = (r1*(1/((vin/tdict[7]) - 1)))
# tdict[8] = (r1*(1/((vin/tdict[8]) - 1)))
# tdict[9] = (r1*(1/((vin/tdict[9]) - 1)))
# tdict[10] = (r1*(1/((vin/tdict[10]) - 1)))
# tdict[11] = (r1*(1/((vin/tdict[11]) - 1)))
# tdict[12] = (r1*(1/((vin/tdict[12]) - 1)))
# tdict[13] = (r1*(1/((vin/tdict[13]) - 1)))
# tdict[14] = (r1*(1/((vin/tdict[14]) - 1)))
# tdict[15] = (r1*(1/((vin/tdict[15]) - 1)))
# tdict[16] = (r1*(1/((vin/tdict[16]) - 1)))
# tdict[17] = (r1*(1/((vin/tdict[17]) - 1)))
# tdict[18] = (r1*(1/((vin/tdict[18]) - 1)))
# tdict[19] = (r1*(1/((vin/tdict[19]) - 1)))
# the temperature of the surroundings of the PT100 from the current resistance, reference resistance(r0), reference temperature & temperature coefficient of the PT100 . Note: Temperature coefficient of PT100 is 0.003851/degree celcius.
# tdict[0] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[1] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[2] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[3] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[4] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[5] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[6] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[7] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[8] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[9] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[10] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[11] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[12] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[13] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[14] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[15] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[16] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[17] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[18] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
# tdict[19] = ((tdict[i] + r0*((alpha*t0)-1))/(r0*alpha))
